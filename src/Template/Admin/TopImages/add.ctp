<?php
  $this->layout = 'admin';
  $this->assign('title', __d('CakeSlide', 'Top Slide').'登録 - '.__d('CakeSlide', 'Website Admin Title').' | '.__d('CakeSlide', 'Website Title'));
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active" aria-current="page"><?= __d('CakeSlide', 'Top Slide') ?>登録</li>
</ol>

<div class="container">
  <div class="row align-items-end mb-2">
    <div class="col-md">
      <h2><?= __d('CakeSlide', 'Top Slide') ?>登録<hr class="d-none d-md-block"></h2>
    </div>
  ...
  <div class="card admin">
    ...
    <div class="card-body">
      ...
      <?php endif; ?>
      <?= $this->Form->create($topImage, ['type' => 'file', 'templates' => 'app_form_bootstrap']); ?>
      <?php
        echo $this->Form->control('name', ['label'=>'名前（画像の説明）', 'class'=>'form-control']);
        echo $this->Form->control('file', ['label'=>__d('CakeSlide', 'Top Slide').'画像', 'class'=>'form-control', 'type'=>'file']);
      ?>
